...
public class TestNativeLibraryLoader {
    ...
    public void testFindNonExistingFile() {
        Assertions.assertThrows(FileNotFoundException.class, () -> NativeLibraryLoader.findFile("testFindFile", NativeLibraryLoader.class, pathname -> false));
    }
